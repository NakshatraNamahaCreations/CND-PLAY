  ...
  React.useImperativeHandle(ref, () => ({
    showIndieMovieCreateChildModal(single_indie_movie_data) {
      ...
      set_indie_movie_data({
        ...
        amount: single_indie_movie_data.data.pricing.amount,
        validity: single_indie_movie_data.data.pricing.validity,
    ...
    <div className="mt-2 row">
      <div className="mt-2 container-fluid">
        <i
          ...
          onClick={() => showIndieMovieFilter(!showFilter)}
        ></i>
        <i
          className="mdi mdi-plus-circle-outline float-right mr-2"
          onClick={showIndieMovieCreateModal}
        ></i>
      </div>
      <div className="mt-2 mb-2 container-fluid">
        <div className="row">{showFilter ? <IndieMovieFilter /> : ""}</div>
      </div>
      {showModal == "show" ? (
                  ...
                  <div className="row">
                    ...
                    <div className="mb-2 col-md-4">
                      ...
                      <input
                        ...
                        defaultValue={
                          !is_edit
                            ? indie_movie_data.pricing?.amount
                    ...
                    <div className="mb-2 col-md-4">
                      ...
                      <input
                        ...
                        defaultValue={
                          !is_edit
                            ? indie_movie_data.pricing?.validity
