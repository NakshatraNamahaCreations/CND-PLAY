...
exports.createSection = (req, res) => {
    ...
    const q = "INSERT INTO `m_section` ("+columns+") VALUES ("+values+")";
...
exports.getSection = (req, res) => {
  ...
  const q = "select * from m_section "+where;
  db.query(q, params, (err, data) => {
  //   console.log(err, data);
    if (err) return res.json({ error: err.sqlMessage });
    else return res.json({ data });
...
exports.updateSection = (req, res) => {
  ...
  const q = "UPDATE `m_section` " + set_data + ' ' + where;
...
// exports.changeStatusSection = (req, res) => {
//   const data = req.body.data.data;
//   const filter = req.body.data.filter;
//   let params = [];
//   let set_data = '';
