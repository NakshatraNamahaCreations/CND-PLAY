...
exports.list = async (req, res) => {
    ...
    if(datacount === undefined || page === undefined) {
        return res.json({"link" : `http://localhost:8081/general/list?datacount=${datacount}&page=${page}`});
    } else {
...
exports.create = async (req, res) => {
    ...
    if(facebook === undefined || instagram === undefined || youtube === undefined) {
        return res.json({"link" : `http://localhost:8081/general/create?facebook=${facebook}&instagram=${instagram}&youtube=${youtube}`});
    } else {
...
exports.update = async (req, res) => {
    ...
    if(likes === undefined || views === undefined) {
        return res.json({"link" : `http://localhost:8081/general/update?id=${id}&facebook=${facebook}&instagram=${instagram}&youtube=${youtube}`});
    } else {
